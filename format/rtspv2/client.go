...
import (
	...
	"github.com/souliot/joy4/codec"
	"github.com/souliot/joy4/codec/aacparser"
	"github.com/souliot/joy4/codec/h264parser"
	"github.com/souliot/joy4/codec/h265parser"
	"github.com/souliot/joy4/format/rtsp/sdp"
)
		...
		for _, nal := range nalRaw {
			if client.videoCodec == av.H265 {
				...
				case naluType == 8:
					client.CodecUpdatePPS(nal)
				case naluType == 24:
					client.Println("24 Type need add next version report https://github.com/souliot/joy4")
				case naluType == 28:
